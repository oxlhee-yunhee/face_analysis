...
핵심 아이디어: 정상적인 얼굴은 표정을 만들 때 좌우가 **시간적으로, 크기 면에서 대칭적으로** 움직입니다. 안면비대칭 또는 구안와사는 이 협응이 무너집니다. 따라서 이를 프레임 단위로 좌우 랜드마크 궤적을 비교하면, 육안으로는 보이지 않는 미세한 운동 제어 결함을 관찰할 수 있습니다.
